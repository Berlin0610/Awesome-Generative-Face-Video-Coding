...
- (JVET July 2024) [**JVET-AI0186**] **AHG9: On picture order count and timing information for gfv generated pictures** L.chen, O. Chubach, Y.-W. Huang, L. Shaw (MediaTek) [Proposal](https://jvet-experts.org/doc_end_user/current_document.php?id=14445)
...
- (JVET July 2024) [**JVET-AI0192**] **AHG9: On GFV picture order and timing** Y.-K. Wang (Bytedance), K. Yang, Y. Li, Y. Xu (SJTU)(CityU) [Proposal](https://jvet-experts.org/doc_end_user/current_document.php?id=14451)
